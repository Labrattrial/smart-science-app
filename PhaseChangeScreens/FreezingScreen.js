...
export default function FreezingScreen() {
    ...
    >
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
        <View style={[styles.headerContainer, { backgroundColor: isDarkTheme ? '#1F2428' : '#FFFFFF' }]}>
          <Text style={[styles.title, { color: isDarkTheme ? '#E0F7FA' : '#000000' }]}>Freezing</Text>
          <Text style={[styles.subtitle, { color: isDarkTheme ? '#90A4AE' : '#666666' }]}>(Liquid → Solid)</Text>
        </View>

        <View style={[styles.descriptionContainer, { backgroundColor: isDarkTheme ? '#1F2428' : '#FFFFFF' }]}>
          <Text style={[styles.descriptionTitle, { color: isDarkTheme ? '#00B0FF' : '#007AFF' }]}>What is Freezing?</Text>
          <View style={styles.bulletPoint}>
            ...
            <Text style={[styles.description, { color: isDarkTheme ? '#E0F7FA' : '#000000' }]}>
              The process of a liquid changing into a solid when its temperature drops below its freezing point. This happens because as a liquid cools, its molecules slow down and lose energy, eventually being able to arrange themselves into a fixed, ordered structure characteristic of a solid.
            </Text>
          </View>
          <View style={styles.bulletPoint}>
            <Text style={[styles.bullet, { color: isDarkTheme ? '#00B0FF' : '#007AFF' }]}>•</Text>
            <Text style={[styles.description, { color: isDarkTheme ? '#E0F7FA' : '#000000' }]}>
              The temperature at which a liquid freezes are called its freezing point. Water, for example, has a freezing point of 0°C<Text style={[styles.boldText, { color: isDarkTheme ? '#00B0FF' : '#007AFF' }]}>(32°F)</Text>.
            </Text>
          </View>
          <View style={styles.bulletPoint}>
            <Text style={[styles.bullet, { color: isDarkTheme ? '#00B0FF' : '#007AFF' }]}>•</Text>
            <Text style={[styles.description, { color: isDarkTheme ? '#E0F7FA' : '#000000' }]}>
              Freezing is a reversible process. When a solid is heated, it will melt back into a liquid, returning to its original state.
            </Text>
          </View>
        </View>
        ...
        <View style={styles.exampleSection}>
          <View style={[styles.animationBox, { backgroundColor: isDarkTheme ? '#1F2428' : '#FFFFFF' }]}>
            ...
            <Text style={[styles.exampleText, { color: isDarkTheme ? '#90A4AE' : '#666666' }]}>Water turns into ice in the freezer</Text>
            <View style={[styles.exampleContainer, { backgroundColor: isDarkTheme ? '#14181C' : '#F5F5F5' }]}>
              <Video
                source={require('../assets/phases/freezing.mp4')}
