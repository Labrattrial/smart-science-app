    ...
    >
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
        <View style={[styles.headerContainer, { backgroundColor: isDarkTheme ? '#1F2428' : '#FFFFFF' }]}>
          <Text style={[styles.title, { color: isDarkTheme ? '#E0F7FA' : '#000000' }]}>Deposition</Text>
          <Text style={[styles.subtitle, { color: isDarkTheme ? '#90A4AE' : '#666666' }]}>(Gas → Solid)</Text>
        </View>

        <View style={[styles.descriptionContainer, { backgroundColor: isDarkTheme ? '#1F2428' : '#FFFFFF' }]}>
          <Text style={[styles.descriptionTitle, { color: isDarkTheme ? '#00B0FF' : '#007AFF' }]}>What is Deposition?</Text>
          <View style={styles.bulletPoint}>
            ...
            <Text style={[styles.description, { color: isDarkTheme ? '#E0F7FA' : '#000000' }]}>
              A phase transition where a substance changes from a gaseous state directly to a solid state without transitioning through the liquid state.
            </Text>
          </View>
        </View>
        ...
        <View style={styles.exampleSection}>
          <View style={[styles.animationBox, { backgroundColor: isDarkTheme ? '#1F2428' : '#FFFFFF' }]}>
            ...
            <Text style={[styles.exampleText, { color: isDarkTheme ? '#90A4AE' : '#666666' }]}>Frost forms on windows during cold mornings</Text>
            <View style={[styles.exampleContainer, { backgroundColor: isDarkTheme ? '#14181C' : '#F5F5F5' }]}>
              <Video
                source={require('../assets/phases/deposition.mp4')}
