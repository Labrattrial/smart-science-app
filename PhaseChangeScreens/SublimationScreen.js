    ...
    >
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
        <View style={[styles.headerContainer, { backgroundColor: isDarkTheme ? '#1F2428' : '#FFFFFF' }]}>
          <Text style={[styles.title, { color: isDarkTheme ? '#E0F7FA' : '#000000' }]}>Sublimation</Text>
          <Text style={[styles.subtitle, { color: isDarkTheme ? '#90A4AE' : '#666666' }]}>(Solid → Gas)</Text>
        </View>

        <View style={[styles.descriptionContainer, { backgroundColor: isDarkTheme ? '#1F2428' : '#FFFFFF' }]}>
          <Text style={[styles.descriptionTitle, { color: isDarkTheme ? '#00B0FF' : '#007AFF' }]}>What is Sublimation?</Text>
          <View style={styles.bulletPoint}>
            ...
            <Text style={[styles.description, { color: isDarkTheme ? '#E0F7FA' : '#000000' }]}>
              Sublimation is a phase change where a substance transitions directly from a solid to a gaseous state, bypassing the liquid phase. This means a substance can change from a solid to a gas without first melting into a liquid.
            </Text>
          </View>
        </View>
        ...
        <View style={styles.moleculesSection}>
          ...
          <View style={[styles.animationBox, { backgroundColor: isDarkTheme ? '#1F2428' : '#FFFFFF' }]}>
            <Text style={[styles.animationTitle, { color: isDarkTheme ? '#00B0FF' : '#007AFF' }]}>Gas Molecules</Text>
            <View style={[styles.moleculeAnimationArea, { backgroundColor: isDarkTheme ? '#14181C' : '#F5F5F5' }]}>
        ...
        <View style={styles.exampleSection}>
          <View style={[styles.animationBox, { backgroundColor: isDarkTheme ? '#1F2428' : '#FFFFFF' }]}>
            ...
            <Text style={[styles.exampleText, { color: isDarkTheme ? '#90A4AE' : '#666666' }]}>Dry ice <Text style={[styles.boldText, { color: isDarkTheme ? '#00B0FF' : '#007AFF' }]}>(solid carbon dioxide)</Text> sublimates into carbon dioxide gas</Text>
            <View style={[styles.exampleContainer, { backgroundColor: isDarkTheme ? '#14181C' : '#F5F5F5' }]}>
              <Video
                source={require('../assets/phases/sublimation.mp4')}
