...
export default function EvaporationScreen() {
    ...
    >
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
        <View style={[styles.headerContainer, { backgroundColor: isDarkTheme ? '#1F2428' : '#FFFFFF' }]}>
          <Text style={[styles.title, { color: isDarkTheme ? '#E0F7FA' : '#000000' }]}>Evaporation</Text>
          <Text style={[styles.subtitle, { color: isDarkTheme ? '#90A4AE' : '#666666' }]}>(Liquid → Gas)</Text>
        </View>

        <View style={[styles.descriptionContainer, { backgroundColor: isDarkTheme ? '#1F2428' : '#FFFFFF' }]}>
          <Text style={[styles.descriptionTitle, { color: isDarkTheme ? '#00B0FF' : '#007AFF' }]}>What is Evaporation?</Text>
          <View style={styles.bulletPoint}>
            ...
            <Text style={[styles.description, { color: isDarkTheme ? '#E0F7FA' : '#000000' }]}>
              Is the process by which the matter undergoes the spontaneous transition from a liquid phase to a gas phase. In this process, the molecules of liquid with the addition of heat creates vapor where gas molecules spread out freely and moving constantly.
            </Text>
          </View>
        </View>
        ...
        <View style={styles.exampleSection}>
          <View style={[styles.animationBox, { backgroundColor: isDarkTheme ? '#1F2428' : '#FFFFFF' }]}>
            ...
            <Text style={[styles.exampleText, { color: isDarkTheme ? '#90A4AE' : '#666666' }]}>Water evaporates from a puddle</Text>
            <View style={[styles.exampleContainer, { backgroundColor: isDarkTheme ? '#14181C' : '#F5F5F5' }]}>
              <Video
                source={require('../assets/phases/evaporation.mp4')}
